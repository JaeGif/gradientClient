...
function NavBar() {
  return (
    <>
      ...
      <nav className='shadow-[0_-1px_50px_1px_rgba(0,0,0,.2)] sm:border-none sm:gap-10 bg-white z-10 fixed bottom-0 left-0 lg:top-0 flex lg:flex-col w-screen lg:w-1/5 lg:min-w-[250px] lg:min-h-screen lg:max-h-screen lg:pl-4 lg:pr-4 lg:pt-4 lg:shadow-md'>
